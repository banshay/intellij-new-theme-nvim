...
function M.setup()
	local config = require("intellij-new-theme").config
	local palette = require("intellij-new-theme.palette").palette
	...
	local groups = {
		...
		IncSearch = { fg = palette.light, bg = palette.selection, bold = true }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
		...
		Keyword = { fg = palette.orange }, --  any other keyword
		...
		["@constant.rust"] = { fg = palette.purple }, -- Built-in constant values: `nil` in Lua.
		...
		["@namespace"] = { fg = palette.normal }, -- Identifiers referring to modules and namespaces.
		...
		["@type"] = { fg = palette.normal }, -- Type (and class) definitions and annotations.
		["@type.qualifier"] = { fg = palette.orange }, -- Type (and class) definitions and annotations.
